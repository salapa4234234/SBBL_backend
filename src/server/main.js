...
app.patch("/api/forget_password", (req, res) => {
  ...
  db.query(query, [values], (err, data) => {
    ...
    let content = `
    <p>Please <a href="https://phonebook.salapabikasbank.com.np/forget-password/email=${email}">Forget Passowrd</a></p>
    `;
...
app.post("/api/register", async (req, res) => {
  ...
  db.query(query, [...values], (err, data) => {
    ...
    const randomString = "kdjfalksd";
    let content = `
    <p>Hi ${firstName},please <a href="https://phonebook.salapabikasbank.com.np/email-verification/email=${email}/varify/token=${randomString}">Verify</a> your email}</p>
    `;
    sendMail(email, subject, content);
